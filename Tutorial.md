...
* The complete histogram example at https://github.com/nicolasstucki/multisets-examples/tree/master/src/main/scala/examples/histogram.
* Implementation of a generic genetic algorithm using bags. With to simple applications that use it: simple bit accumulation and Traveling Salesman. At https://github.com/nicolasstucki/multisets-examples/tree/master/src/main/scala/examples/genetic_algorithm.
* Directory analyser: uses different equivalences to classify keep track and classify files. At https://github.com/nicolasstucki/multisets-examples/tree/master/src/main/scala/examples/directory.
