...
class IntMutableHashBagOnMultiplicitiesTest extends IntBagTest {
  ...
  implicit lazy val bagBucketFactory = mutable.BagConfiguration.Hashed.ofMultiplicities[Int]
...
class IntMutableHashBagOnBagBucketBagTest extends IntBagTest {
  ...
  implicit lazy val bagBucketFactory = mutable.BagConfiguration.Hashed.ofBagBucketBag[Int]
