...
class IntImmutableTreeBagOnMultiplicitiesTest extends IntBagTest {
  implicit lazy val bagBucketFactory = immutable.BagBucketConfiguration.Sorted.ofMultiplicities[Int]

  override def emptyBag = immutable.TreeBag.empty[Int]
}

class IntImmutableTreeBagOnSortedBagBucketBagTest extends IntBagTest {
  implicit lazy val bagBucketFactory = immutable.BagBucketConfiguration.Sorted.ofBagBucketBag[Int]

  override def emptyBag = immutable.TreeBag.empty[Int]
}

class IntImmutableTreeBagOnVectorBucketTest extends IntBagTest {
  implicit lazy val bagBucketFactory = immutable.BagBucketConfiguration.Sorted.ofVectors[Int]
